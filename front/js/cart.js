...
function listenDeleteItem() {
  ...
  for (let item of deleteProduct) {
    ...
    item.addEventListener("click", function (event) {
      ...
      if (
        window.confirm(
          `Êtes-vous sûr de vouloir supprimer cet article ? Si oui cliquez sur "OK" sinon "ANNULER".`
        )
      ) {
...
function validFirstName() {
  ...
  if (!testFirstName) {
    ...
    firstNameErrorMsg.textContent =
      'Veuillez renseigner le champ "Prénom" correctement.';
    return false;
  } else {
    firstNameErrorMsg.textContent = "";
  }
...
function validLastName() {
  ...
  if (!testLastName) {
    lastNameErrorMsg.textContent =
      'Veuillez renseigner le champ "Nom" correctement.';
  } else {
    lastNameErrorMsg.textContent = "";
  }
}
...
function validAddress() {
  ...
  if (!testAddress) {
    addressErrorMsg.textContent =
      'Veuillez renseigner le champ "Adresse" correctement.';
  } else {
    addressErrorMsg.textContent = "";
  }
}
...
function validCity() {
  ...
  if (!testCity) {
    cityErrorMsg.textContent =
      'Veuillez renseigner le champ "Ville" correctement.';
  } else {
    cityErrorMsg.textContent = "";
  }
}
...
function validEmail() {
  ...
  if (!testEmail) {
    emailErrorMsg.textContent =
      "Veuillez renseigner le champ \"Email\" correctement. N'oubliez pas l'@.";
  } else {
    emailErrorMsg.textContent = "";
  }
}
...
function listenOrderButton() {
  orderButton.addEventListener("click", function (event) {
    ...
    if (
      ...
      !checkForm();
      alert(
        "Veuillez remplir tout les champs du formulaire avant de passer commande."
      );
    }
  });
}
